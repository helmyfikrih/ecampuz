				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title text-left">Data Instansi</h3>
		...
		<div class="modal-dialog modal-dialog-scrollable modal-xl">
			<div class="modal-content">
				...
				<div class="modal-body" id="modalBody">
					<form role="form" id="form" action="<?= base_url('instansi/save') ?>">
						<div class="row">
							<div class="col-sm-12">
								<!-- text input -->
								<div class="form-group">
									<label>Nama</label>
									<input type="text" name="instansi_id" id="instansi_id" class="form-control" placeholder="instansi_id" hidden>
